...
func TestCreateRequestUri(t *testing.T) {
	...
	cases := []requestUriTestCase{
		{"base", url.Values{}, "base"},
		{"base", url.Values{"test": []string{""}}, "base?test="},
		{"base", url.Values{"test": []string{"value"}}, "base?test=value"},
		{"base", url.Values{"test": []string{"value with space"}}, "base?test=value+with+space"},
		{"base", url.Values{"test1": []string{"value1"}, "test2": []string{"value2"}}, "base?test1=value1&test2=value2"},
	}
	for _, c := range cases {
